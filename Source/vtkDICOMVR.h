...
public:
  ...
  bool HasNumericValue() const {
    return (((1ull << this->Key) & 0x1848500740ull) != 0); }
  ...
  bool HasSingleValue() const {
    return (((1ull << this->Key) & 0x80801000ull) != 0); }
  //@}
