...
int main(int argc, char *argv[])
{
  ...
  { // test VR and VL
  vtkDICOMValue v = vtkDICOMValue(vtkDICOMVR::CS, "HELLO\\THERE", 11);
  ...
  v = vtkDICOMValue(vtkDICOMVR::CS, "HELLO\\THERE", 11);
  ...
  { // test equality
  vtkDICOMValue v, u;
  v = vtkDICOMValue(vtkDICOMVR::CS, "hello", 5);
  u = vtkDICOMValue(vtkDICOMVR::CS, "hello", 5);
  TestAssert(u == v);
  v = vtkDICOMValue(vtkDICOMVR::CS, "hello", 5);
  u = vtkDICOMValue(vtkDICOMVR::DS, "1.234", 5);
  TestAssert(u != v);
  v = vtkDICOMValue(vtkDICOMVR::CS, "hello", 5);
  u = vtkDICOMValue(vtkDICOMVR::CS, "there", 5);
  TestAssert(u != v);
  v = vtkDICOMValue(vtkDICOMVR::CS, "hello", 5);
  u = vtkDICOMValue(vtkDICOMVR::SH, "hello", 5);
  TestAssert(u != v);
  ...
  vptr[0] = vtkDICOMValue(vtkDICOMVR::DS, "1.3234", 6);
  ...
  uptr[1] = vtkDICOMValue(vtkDICOMVR::DS, "1.4", 3);
  uptr[2] = vtkDICOMValue(vtkDICOMVR::DS, "-1e-5", 5);
  TestAssert(v == v);
  TestAssert(u == v);
  uptr[1] = vtkDICOMValue(vtkDICOMVR::DS, "1", 1);
  TestAssert(u != v);
  vptr[1] = vtkDICOMValue(vtkDICOMVR::IS, "1", 1);
  TestAssert(u != v);
  vptr[0] = uptr[0];
  vptr[1] = uptr[1];
  vptr[2] = uptr[2];
